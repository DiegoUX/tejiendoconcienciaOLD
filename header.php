	...
	<div id="page">
		...
		<header id="header">
			...
			<div class="small-logo">
				<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="">
					<img src="/wp-content/themes/tejiendoconciencia-child/images/small-logo.png" alt="TejiendoConCiencia Logo">
				</a>
			</div>
